...
import { piperTtsPlay, releasePiperSession } from "./providers/piper.js";
...
// Release the resident Piper model only when this page/webview is actually being discarded.
// Do not tie this to stopPlayback(), which is called between normal card playbacks.
window.addEventListener("pagehide", () => {
    releasePiperSession().catch(error => console.warn("Failed to release Piper session:", error));
}, { once: true });
