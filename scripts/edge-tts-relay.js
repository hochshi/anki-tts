...
function ssmlMessage(requestId, voice, pitch, rate, volume, text) {
...
function synthesize({ text, voice, pitch, rate, volume }) {
    return new Promise((resolve, reject) => {
        ...
        ws.on("close", () => {
            ...
            if (!gotAudio)
                reject(new Error("Edge TTS relay: no audio received (upstream rejected the request)"));
            else
